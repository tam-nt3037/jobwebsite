    ...
    <div class="single-slidebar">
        ...
        <ul class="cat-list">
            @foreach($location_job as $location)
                <li><a class="justify-content-between d-flex" href="category.html"><p>{{$location->location_work}}</p><span>{{$location->count}}</span></a></li>
            @endforeach
        </ul>
    </div>
        ...
        <div class="active-relatedjob-carusel">
            @foreach($top_rate as $top)
                <div class="single-rated">
                    ...
                    <a href="single.html"><h4> {{$top->job_title}} </h4></a>
    ...
    <div class="single-slidebar">
        ...
        <ul class="cat-list">
            @foreach($category_job as $category)
                <li><a class="justify-content-between d-flex" href="category.html"><p>{{$category->name_group_category}}</p><span>{{$category->count}}</span></a></li>
            @endforeach
        </ul>
    </div>
