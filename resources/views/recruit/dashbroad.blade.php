                            ...
                            <div class="col-lg-12">
                                ...
                                <div style="padding: 0 0 10px 0; ">
                                    <form class="form-inline">
                                        ...
                                        <button class="btn btn-outline-primary" type="button" style="border-color: #007bff;">Search</button>
                                    </form>
                                </div>
                                ...
                                <div class="table-responsive table--no-card m-b-40" >
                                    <table class="table table-borderless table-striped table-earning">
                                        ...
                                        @foreach($total_job as $total)
                                            <tr class="item">
                                                <div class="row">
                                                    ...
                                                    <td class="col-md-3" style=" text-align:center;">
                                                        <a data-toggle="modal" data-target="#overView{{$total->id_posts}}">{{$total->job_title}}</a>
                                                    </td>
                                                    <td class="col-md-1" style=" text-align:center;">{{$total->applied}}</td>
                                                    <td class="col-md-2" style=" text-align:center;">{{$total->date_posted}}</td>
                                                    <td class="col-md-2" style=" text-align:center;">...</td>
                                                    <td class="col-md-3" style=" text-align:center;">
                                                        <div class="row" style="width: 100%; margin:0">
                                                            <a href="/admin/edit_post/{{$total->id_posts}}" class="col-md-6 col-sm-6">Edit<a>
                                                            <a href="/admin/delete_post/{{$total->id_posts}}" class="col-md-6 col-sm-6">Delete<a>
                                                        </div>
                                                    </td>
                                                </div>
                                            </tr>
                                            ...
                                            <!-- Modal -->
                                            <div class="modal fade" id="overView{{$total->id_posts}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                <div class="modal-dialog modal-lg" role="document">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h3 class="modal-title" id="exampleModalLabel">{{$total->job_title}}</h3>
                                                    ...
                                                    <div class="modal-content" style="padding:15px">
                                                        @foreach($candidates as $aplly)
                                                            @if($aplly->id_post_news == $total->id_posts)
                                                                <div class="modal-body" style="text-align: center; color: gray; padding: 5px">
                                                                    <div class="row">
                                                                        <div class="col-md-5">{{$aplly->last_name}} {{$aplly->first_name}}</div>
                                                                        <div class="col-md-5 text-left">{{$aplly->email}}</div>
                                                                        <div class="col-md-2"><a href="/admin/show_profile/{{$aplly->id_status_candidate_profile}}">See Profile</a></div>
                                                                    </div>
                                                                </div>
